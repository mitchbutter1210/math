...
public class Power {
	...
	private void initialize() {
		...
		lblEnterBase.setBounds(174, 34, 102, 15);
		frmPower.getContentPane().add(lblEnterBase);
		
		base = new JTextField();
		base.setBounds(162, 85, 114, 19);
		...
		power.setBounds(162, 186, 114, 19);
		...
		answer.setBounds(162, 266, 114, 19);
		...
		btnClear.setBounds(273, 359, 117, 25);
		...
		btnPower.setBounds(79, 359, 117, 25);
